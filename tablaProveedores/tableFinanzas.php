        ...
        $(document).ready(function () {
            ...
            function fetch_data()
            {
                var dataTable = $('#user_data').DataTable({
                    ...
                    "bInfo": false,
                    "ajax": {
                        url: "../tablaProveedores/fetch4.php",
                        type: "POST",
                        dataType: "json"
                    }
                });
            ...
            {
                $.ajax({
                    url: "../tablaProveedores/editAdmin/updateFinanzas.php",
                    method: "POST",
            ...
            $(document).on('blur', '.update', function () {
                ...
                if (column_name != "rut" && column_name != "email") {
                    ...
                    window.location = "tableFinanzas.php";
                }
            });
            $('#add').click(function () {
                var html = '<tr>';
            ...
            $(document).on('click', '#borrado', function () {
              if (confirm("\u00BFEst\u00e1s seguro que deseas eliminar todos los datos?"))
                window.location = "../tablaProveedores/editAdmin/deleteTotalF.php";
            ...
            $(document).on('click', '#insert', function () {
                ...
                if (razonSocial != '' && atencionProveedor == '') {
                    $.ajax({
                        url: "../tablaProveedores/editAdmin/insertFinanzas.php",
                        method: "POST",
            ...
            $(document).on('click', '.delete', function () {
                ...
                {
                    $.ajax({
                        url: "../tablaProveedores/editAdmin/deleteFinanzas.php",
                        method: "POST",
                        data: {id: id},
                        success: function (data) {
                            $('#alert_message').html('<div class="alert alert-success">' + data + '</div>');
