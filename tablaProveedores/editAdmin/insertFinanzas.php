...
$query1 = "SELECT id FROM listado order by id DESC LIMIT 1";
...
$dato= "SELECT id FROM categorias WHERE nombre = '".$categ."'";
...
if($contar == 0 ){//si el id no existe
  $query3= "INSERT INTO categorias (nombre) VALUES ('$categ')";
  ...
  $query = "INSERT INTO listado(id, razonSocial, rut, direccion, ciudad, telefono, atencionProveedor, correo, idCategoria)"
