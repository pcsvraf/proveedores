...
if(isset($_POST["id"])){
 ...
 $query = "UPDATE listado SET ".$_POST["column_name"]."='$value' WHERE id = '".$_POST["id"]."'";

 if (strcmp($_POST["column_name"], "nombre") === 0){
    $dato= "SELECT id FROM categorias WHERE nombre = '".$value."'";
    ...
    if($contar == 0){//si el id no existe
      $query3= "INSERT INTO categorias (nombre) VALUES ('$value')";
      $query5 = "SELECT id FROM categorias order by id DESC LIMIT 1";
      ...
      $query3=  "UPDATE listado SET idCategoria='$id_nuevo' WHERE id = '".$_POST["id"]."'";
      if(mysqli_query($connect, $query3))
      {
      ...
      $query3=  "UPDATE listado SET idCategoria='$prueba' WHERE id = '".$_POST["id"]."'";
      if(mysqli_query($connect, $query3))
      {
        echo 'Proveedor Actualizado';
      }
